.. image:: https://github.com/unifyai/unifyai.github.io/blob/master/img/externally_linked/ivy_gym/logo.png?raw=true
   :width: 100%
...
.. raw:: html
    ...
    <a href="https://github.com/unifyai/gym/actions?query=workflow%3Adocs">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/unifyai/gym/docs?label=docs">
    </a>
    <a href="https://github.com/unifyai/gym/actions?query=workflow%3Anightly-tests">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/unifyai/gym/nightly-tests?label=tests">
    </a>
